            ...
            <div class="col-sm-8">
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input id="unit" v-model="tempProduct.unit" type="unit"
                ...
                type="text" class="form-control" placeholder="請輸入產品說明" required>
            </textarea>
                </div>
                <div class="form-group">
                ...
                class="form-control" placeholder="請輸入產品描述" required>
            </textarea>
                </div>
                <div class="form-group">
